...
{{ resize_image(file="old.png", size=700, alt="Old mountain scape attempt") }}
...
{{ resize_image(file="perlin.png", size=700, alt="Basic perlin noise image") }}
